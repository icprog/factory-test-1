...
int eth_test (char *dev_name, int packet_num)
{
	...
	printf ("MAC address for interface %s is ", dev_name);
	for (i=0; i<5; i++) {
	...
	printf ("dst MAC address for interface is:");
	for (i=0; i<5; i++) {
